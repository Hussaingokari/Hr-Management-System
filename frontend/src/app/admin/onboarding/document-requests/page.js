        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
            <div style={{ background: 'var(--card-bg)', borderRadius: '12px', padding: '24px', width: '420px', maxWidth: '90%' }}>
                ...
                <textarea
                    ...
                    placeholder="e.g. Photo is blurry, please upload a clearer image."
                    rows={3}
                    style={{ width: '100%', padding: '10px 12px', border: '1.5px solid #e2e8f0', borderRadius: '10px', fontSize: '13px', outline: 'none', resize: 'vertical', boxSizing: 'border-box', fontFamily: 'inherit', marginBottom: '16px' }}
                />
        ...
        <div style={{ background: 'var(--card-bg)', borderRadius: '12px', border: '1px solid var(--card-border)', padding: '18px 20px', marginBottom: '12px', boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
            <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: '12px', color: '#3b82f6', marginBottom: '2px' }}>
                        {doc.employeeName} · {doc.employeeCode}
                    </div>
                ...
                {tab === 'PENDING' && (
                    <div style={{ display: 'flex', gap: '8px', flexShrink: 0 }}>
                        ...
                        <button
                            ...
                            disabled={isActing}
                            style={{ padding: '7px 14px', background: '#fee2e2', color: '#dc2626', border: 'none', borderRadius: '8px', fontSize: '12px', fontWeight: '700', cursor: isActing ? 'not-allowed' : 'pointer' }}>
                            Reject
                        </button>
                    </div>
                )}
...
export default function DocumentRequestsPage() {
    ...
    const fetchCounts = useCallback(async () => {
        try {
            ...
            // non-fatal — counts are just badges
        }
    }, []);
